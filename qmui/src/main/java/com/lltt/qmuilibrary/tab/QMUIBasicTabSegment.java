...
package com.lltt.qmuilibrary.tab;
...
import com.lltt.qmuilibrary.R;
import com.lltt.qmuilibrary.layout.IQMUILayout;
import com.lltt.qmuilibrary.layout.QMUILayoutHelper;
import com.lltt.qmuilibrary.util.QMUIColorHelper;
 ...
 * @date 2016-01-27
 */
public class QMUIBasicTabSegment extends HorizontalScrollView implements IQMUILayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int indicatorHeight = array.getDimensionPixelSize(
                R.styleable.QMUITabSegment_qmui_tab_indicator_height, QMUIDisplayHelper.dp2px(context, 2));
    ...
    private void layoutIndicator(QMUITab model, boolean invalidate) {
        ...
        mIndicator.updateInfo(model.contentLeft, model.contentWidth, model.selectColor);
        if (invalidate) {
            mContentLayout.invalidate();
        }
    }
    ...
    private void layoutIndicatorInTransition(QMUITab preModel, QMUITab targetModel, float offsetPercent) {
        ...
        int indicatorColor = QMUIColorHelper.computeColor(
                preModel.selectColor,
                targetModel.selectColor,
                offsetPercent);
