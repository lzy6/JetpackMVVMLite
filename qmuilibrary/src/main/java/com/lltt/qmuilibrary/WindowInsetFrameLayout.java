...
import com.lltt.qmuilibrary.util.QMUIWindowInsetHelper;
 ...
 * @date 2016-03-25
 */
public class WindowInsetFrameLayout extends FrameLayout implements IWindowInsetLayout {
    ...
    public WindowInsetFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WindowInsetFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
