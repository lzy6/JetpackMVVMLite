 ...
 * cache 功能主要是保证在需要多次刷新数据或布局的情况下（{@link android.widget.ListView} 或  RecyclerView 的 itemView）
 * 复用已存在的 {@link View}。
 * QMUI 用于  QMUITabSegment  中   com.qmuiteam.qmui.widget.tab.QMUITab 与数据的适配。
 *
 * @author cginechen
 * @date 2016-11-27
 */
