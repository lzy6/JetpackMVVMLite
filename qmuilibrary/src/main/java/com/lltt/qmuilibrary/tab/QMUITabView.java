...
import com.lltt.qmuilibrary.util.QMUICollapsingTextHelper;
import com.lltt.qmuilibrary.util.QMUIColorHelper;
import com.lltt.qmuilibrary.util.QMUILangHelper;
import com.lltt.qmuilibrary.util.QMUIResHelper;
...
public class QMUITabView extends FrameLayout {
    ...
    private Button ensureSignCountView(Context context) {
        if (mSignCountView == null) {
    ...
    protected Button createSignCountView(Context context) {
