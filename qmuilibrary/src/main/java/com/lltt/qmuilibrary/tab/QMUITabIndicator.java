...
import com.lltt.qmuilibrary.util.QMUIDrawableHelper;
...
//    =new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT,new int[]{Color.parseColor("#FF3D89"), Color.parseColor("#671DFF")})
    /**
    ...
    public QMUITabIndicator(@NonNull GradientDrawable drawable, boolean indicatorTop,
                            boolean isIndicatorWidthFollowContent) {
...
//            QMUIDrawableHelper.setDrawableTintColor(mIndicatorDrawable, color);
    ...
    protected void handleSkinChange(
